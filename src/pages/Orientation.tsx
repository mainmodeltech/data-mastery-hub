...
const results: Record<string, Result> = {
    powerbi: {
        ...
        subtitle: "Business Intelligence · 6 semaines",
        description:
        ...
        nextStep: "Prochaine session : 28 Mars 2025 · 15 places restantes",
    ...
    dataanalyst: {
        ...
        subtitle: "SQL & Python · 10 semaines",
        description:
        ...
        nextStep: "Prochaine session : 25 Mars 2026 · 15 places restantes",
        ctaLabel: "Réserver ma place",
        ...
        testimonial: {
            name: "Khoudia DIAO",
            role: "Investment Analyst · Mazars",
